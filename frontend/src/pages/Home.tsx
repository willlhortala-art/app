...
const VEHICLES: VehicleModel[] = [
  ...
  {
    id: 'remorque-pizza-feux-bois',
    name: 'Remorque Pizza Four à Bois',
    type: 'remorque',
    category: 'Standard',
    description: 'Four à bois traditionnel intégré, plan de travail et saladette réfrigérée.',
    basePrice: 34000,
    emptyWeightKg: 1350,
    ptacKg: 2000,
    lengthMeters: 4.2,
    ...
    defaultPowerSupply: 'Mono 230 V standard',
    alertLevel: 'vert',
    alertMessage: 'Vert : fonctionnement au bois, électricité limitée au froid et à l\'éclairage[cite: 1].',
  },
  {
  ...
  {
    id: 'remorque-rotisserie',
    name: 'Remorque Rôtisserie / Volailles',
    type: 'remorque',
    category: 'Standard',
    description: 'Rôtissoire gaz panoramique, vitrine chaude, armoire froide et plan de découpe.',
    basePrice: 31000,
    emptyWeightKg: 1150,
    ptacKg: 1800,
    lengthMeters: 3.8,
    ...
    defaultPowerSupply: 'Mono 230 V standard',
    alertLevel: 'vert',
    alertMessage: 'Vert si rôtissoire gaz ; attention à la puissance si options électriques[cite: 1].',
  },
  {
    id: 'remorque-glaces',
    name: 'Remorque Glaces / Bar à Jus / Boissons',
    type: 'remorque',
    category: 'Standard',
    description: 'Vitrine à glace ventilée, blender professionnel, sorbetière ou machine à granita.',
    basePrice: 28500,
    emptyWeightKg: 950,
    ptacKg: 1500,
    lengthMeters: 3.2,
    widthMeters: 2.0,
    licenseRequired: 'Permis B',
    defaultPowerSupply: 'Mono 230 V ou prise 32 A',
    alertLevel: 'orange',
    alertMessage: 'Orange : vérifier le cumul des machines à froid et à granita[cite: 1].',
  },
  {
    id: 'camion-burger',
  ...
  {
    id: 'camion-pizza',
    name: 'Camion Magasin Pizza',
    type: 'camion',
    category: 'Standard',
    description: 'Comptoir à pizza, saladette, four à bois ou électrique intégré sur porteur.',
    basePrice: 51000,
    emptyWeightKg: 2700,
    ptacKg: 3500,
    lengthMeters: 4.2,
    ...
    defaultPowerSupply: '32 A ou triphasé',
    alertLevel: 'orange',
    alertMessage: 'Orange selon le type de four (gaz vs électrique)[cite: 1].',
  },
  {
    id: 'camion-marche',
    name: 'Camion Marché / Boucherie / Fromagerie',
    type: 'camion',
    category: 'Standard',
    description: 'Vitrines réfrigérées inclinées, étals relevables, groupe frigorifique porteur.',
    basePrice: 55000,
    emptyWeightKg: 2900,
    ptacKg: 3500,
    lengthMeters: 4.5,
    ...
    defaultPowerSupply: '32 A ou triphasé',
    alertLevel: 'orange',
    alertMessage: 'Orange : forte consommation de froid en continu sur les marchés[cite: 1].',
  },
  {
    id: 'camion-pressing',
